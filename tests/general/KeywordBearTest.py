...
class KeywordBearDiffTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dep_results = {'AnnotationBear': HiddenResult(
            'AnnotationBear', AnnotationContent([AnnotationRange(
                'singleline_comment', [])]))}
    ...
    def test_keyword_in_comment(self):
        ...
        dep_results = {'AnnotationBear': HiddenResult(
            'AnnotationBear', AnnotationContent(
                [AnnotationRange('singleline_comment', [[], [], [], 123])]))}
    ...
    def test_keyword_not_in_comment(self):
        ...
        dep_results = {
            ...
            [self.annotation_bear_result_type(
                AnnotationContent([AnnotationRange(
