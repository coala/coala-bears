...
deps="libclang1-3.4 indent mono-mcs chktex r-base julia golang-go luarocks verilator cppcheck flawfinder devscripts libjpeg-progs jpegoptim pngcrush optipng"
deps_infer="m4 opam"
