...
class Scala11LintBear:
    ...
    LICENSE = 'AGPL-3.0'
    INCLUDE_LOCAL_FILES = {'scalastyle_2.11.jar', 'scalalint_config.xml'}
    ...
    def setup_dependencies(self):
        type(self).jar = self.download_cached_file(
            ...
            'scalastyle/scalastyle_2.11/0.8.0/scalastyle_2.11-0.8.0-batch.jar',
            'scalastyle_2.11.jar')
    ...
    def create_arguments(filename, file, config_file,
        ...
        """
        return ('-jar', Scala11LintBear.jar, filename, '--config',
                scalalint_config)
